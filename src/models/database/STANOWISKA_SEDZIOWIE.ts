export class STANOWISKA_SEDZIOWIE{
    ...
    static validator(body: STANOWISKA_SEDZIOWIE = {stanowiska_sedziowie_id: undefined, stanowisko_id: undefined, uzytkownik_id: undefined}): void  {
        if ((typeof body.stanowiska_sedziowie_id !== "number" || body.stanowiska_sedziowie_id.toString().length > 3 || isNaN(body.stanowiska_sedziowie_id)) && typeof body.stanowiska_sedziowie_id !== "undefined") {
