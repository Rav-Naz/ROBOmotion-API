export class WALKI {
    ...
    static validator(body: WALKI = { walka_id: undefined, robot1_id: undefined, robot2_id: undefined, wygrane_rundy_robot1: undefined, wygrane_rundy_robot2: undefined, czas_zakonczenia: undefined, grupa_id: undefined, nastepna_walka_id: undefined, stanowisko_id: undefined }): void {
        if ((typeof body.walka_id !== "number" || body.walka_id.toString().length > 7) && typeof body.walka_id !== "undefined") {
            throw new Error('WALKI.walka_id is not valid');
        }
        if ((typeof body.robot1_id !== "number" || body.robot1_id.toString().length > 6) && typeof body.robot1_id !== "undefined" && typeof body.robot1_id !== "object") {
            throw new Error('WALKI.robot1_id is not valid');
        }
        if ((typeof body.robot2_id !== "number" || body.robot2_id.toString().length > 6) && typeof body.robot2_id !== "undefined" && typeof body.robot2_id !== "object") {
            throw new Error('WALKI.robot2_id is not valid');
        }
        if ((typeof body.wygrane_rundy_robot1 !== "number" || body.wygrane_rundy_robot1.toString().length > 2) && typeof body.wygrane_rundy_robot1 !== "undefined" && typeof body.wygrane_rundy_robot1 !== "object") {
        ...
        if ((typeof body.nastepna_walka_id !== "number" || body.nastepna_walka_id.toString().length > 7) && typeof body.nastepna_walka_id !== "undefined" && typeof body.nastepna_walka_id !== "object") {
            throw new Error('WALKI.nastepna_walka_id is not valid');
        }
        if ((typeof body.grupa_id !== "number" || body.grupa_id.toString().length > 3) && typeof body.grupa_id !== "undefined") {
