export class KATEGORIE_STANOWISKA{
    ...
    static validator(body: KATEGORIE_STANOWISKA = {kategoria_stanowiska_id: undefined, stanowisko_id: undefined, kategoria_id: undefined}): void  {
        if ((typeof body.kategoria_stanowiska_id !== "number" || body.kategoria_stanowiska_id.toString().length > 7 || isNaN(body.kategoria_stanowiska_id)) && typeof body.kategoria_stanowiska_id !== "undefined") {
