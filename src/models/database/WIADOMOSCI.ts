export class WIADOMOSCI{
    ...
    static validator(body: WIADOMOSCI = {wiadomosc_id: undefined, uzytkownik_id: undefined, czas_nadania: undefined, czas_wyslania: undefined, czy_wyslane: undefined, tresc: undefined}): void  {
        if ((typeof body.wiadomosc_id !== "number" || body.wiadomosc_id.toString().length > 10 || isNaN(body.wiadomosc_id)) && typeof body.wiadomosc_id !== "undefined") {
        ...
        if ((typeof body.czy_wyslane !== "number" || body.czy_wyslane.toString().length > 1 || isNaN(body.czy_wyslane)) && typeof body.czy_wyslane !== "undefined") {
